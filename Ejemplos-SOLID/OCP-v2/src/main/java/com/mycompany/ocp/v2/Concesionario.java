...
public class Concesionario {
   ...
   public void generarInventario(){
        Inventario.add(new Automovil("Gasolina", "ABC123", 25000, "Rojo", 2022, "Toyota"));
        Inventario.add(new Automovil("Diésel", "XYZ789", 35000, "Azul", 2021, "Ford"));
        ...
        Inventario.add(new Bus(60, 1, "XYZ789", 120000, "Rojo", 2021, "Volvo"));
        Inventario.add(new Bus(40, 2, "ABC123", 100000, "Azul", 2022, "Mercedes"));
