...
public class PgAdaptador implements DBAdaptador {
    private static final String DB_CONFIG_PATH = "C:\\Users\\Usuario\\Proyectos_netbeans\\Java_aplicaciones\\parcial\\src\\main\\java\\configuracion\\DBPSQL.properties";
    ...
    private static PgAdaptador instancia;
    ...
    public static synchronized PgAdaptador obtenerInstancia() {
        if (instancia == null) {
            instancia = new PgAdaptador();
        }
        return instancia;
    }
